...
export type GoodsMutation = {
  ...
  [GOODS_ACTION_TYPE.SET_CURRENCY_FLUCTUATION](state: GoodsState, payload: string): void;
};
...
export const goodsMutations: MutationTree<GoodsState> & GoodsMutation = {
  ...
  [GOODS_ACTION_TYPE.SET_CURRENCY_FLUCTUATION](state, payload) {
    state.currencyFluctuation = payload;
  },
};
